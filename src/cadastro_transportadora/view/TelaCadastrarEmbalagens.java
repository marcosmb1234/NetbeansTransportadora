 ...
 * @author marco
 */
public class TelaCadastrarEmbalagens extends javax.swing.JFrame {

    /**
     * Creates new form TelaCadastrarEmbalagens
     */
    public TelaCadastrarEmbalagens() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaCadastrarEmbalagens.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaCadastrarEmbalagens().setVisible(true);
            }
        });
    }
